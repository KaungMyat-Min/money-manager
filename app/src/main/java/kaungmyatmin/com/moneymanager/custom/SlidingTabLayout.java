...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private static final int TAB_VIEW_TEXT_SIZE_SP = 18;  // edit to change text size: default is 12
	...
	protected TextView createDefaultTabView(Context context) {
		...
		TextView textView = new CustomTextView(context); // edit to change the type of textview: default is TextView
