...
public class UserDataHandler {
    ...
    public void saveUserProfile(UserData data) {
        ...
        prefEditor.putString(ValHolder.KEY_USERNAME, data.getUserName())
                .putFloat(ValHolder.KEY_SALARY, data.getSalary())
                .putFloat(ValHolder.KEY_SAVE_AMT, data.getSaveAmt())
                .putFloat(ValHolder.KEY_COST_CLOTH, data.getCost_cloth())
                .putFloat(ValHolder.KEY_COST_INTERNET, data.getCost_internet())
                .putFloat(ValHolder.KEY_COST_SMS, data.getCost_sms())
                .putFloat(ValHolder.KEY_COST_TALK, data.getCost_talk())
                .putFloat(ValHolder.KEY_COST_TRANSPORT, data.getCost_transport())
                .putBoolean(ValHolder.KEY_IS_DAILY, data.isDaily());
